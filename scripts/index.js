...
const QUESTION_1 = new Question("Which Superhero is made out of an uncommon steel: ", 
  ["Superman", "Wolverine", "Magneto", "antman"], 2);
const QUESTION_2 = new Question("Which XMen discovered their power in a concentration camp?", 
  ["Captain America", "Magneto", "Storm", "Cyclopse"], 2);
const QUESTION_3 = new Question("Where does Harry and Harmonie watch snape die?", 
  ["In the courtyard", "quiddich arena", "boathouse", "All of the above"], 3);
const QUESTION_4 = new Question("May the odds forever be _____", 
  ["lost", "in your favor", "Questionable", "in the hand of the beholder"], 2);
const QUESTION_5 = new Question("Love is easy, forgetting is hard. Who wrote this poem: ", 
  ["Shakespear", "Jack Nickleson", "Pablo Neruda", "Edgar Allen Poe"], 3);
